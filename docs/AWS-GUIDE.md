...
3. [IAM — Who Gets Access](#3-iam--who-gets-access)
4. [VPC — Your Private Network](#4-vpc--your-private-network)
5. [EC2 — Your Server in the Cloud](#5-ec2--your-server-in-the-cloud)
6. [S3 — File Storage & Website Hosting](#6-s3--file-storage--website-hosting)
7. [SSM Parameter Store — Secrets Management](#7-ssm-parameter-store--secrets-management)
8. [PM2 — Keeping Your Backend Alive](#8-pm2--keeping-your-backend-alive)
9. [Neon DB — Your Database](#9-neon-db--your-database)
