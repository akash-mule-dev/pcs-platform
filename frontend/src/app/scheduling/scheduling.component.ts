...
@Component({
  ...
  template: `
    <div class="page-shell">
      ...
      @else {
        <table mat-table [dataSource]="lines" class="mat-elevation-z1 full">
          <ng-container matColumnDef="line"><th mat-header-cell *matHeaderCellDef>Line</th><td mat-cell *matCellDef="let l">{{ l.lineName }}</td></ng-container>
          <ng-container matColumnDef="scheduled"><th mat-header-cell *matHeaderCellDef>Scheduled (h)</th><td mat-cell *matCellDef="let l">{{ l.scheduledHours }}</td></ng-container>
          <ng-container matColumnDef="capacity"><th mat-header-cell *matHeaderCellDef>Capacity (h)</th><td mat-cell *matCellDef="let l">{{ l.capacityHours }}</td></ng-container>
  ...
  styles: [`
    ...
    table.full { width:100%; } .center { display:flex; justify-content:center; padding:48px; }
